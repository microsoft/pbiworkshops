...
:::image type="content" source="./Media/NewBlankQuery.png" alt-text="New Blank query.":::
...
:::image type="content" source="./Media/ImportModel.png" alt-text="Import Model.":::
...
:::image type="content" source="./Media/EnhancedComputeEngineSettings.png" alt-text="Enhanced compute engine settings.":::
...
1. After you've received the **Success!** notification, return to the workspace and select the **Refresh now** option of the datalfow for the optimization to take effect.
    ...
    :::image type="content" source="./Media/RefreshNow.png" alt-text="Refresh now.":::
...
1. Within **Power BI Desktop**'s **Home** ribbon select the **Get data** button. Within the **Get dialog** window select the **Power Platform** section and then **Dataflows** connector. Select **Connect** to continue to the **Dataflows** navigator window.
    ...
    :::image type="content" source="./Media/ppDataflows.png" alt-text="Power Platform dataflows.":::
...
1. Within the **Navigator** window, navigate to the group Workspace where your dataflow is located and select all of the tables located within the dataflow. Select **Transform Data** when complete to enter the **Power Query Editor** window.
    ...
    :::image type="content" source="./Media/getDataDataflow.png" alt-text="Get dataflow tables.":::
...
1. Navigate to the **DimCustomer** table, holding the **shift** key select the **FirstName**, **MiddleName** and **LastName** columns, right click one of the selected columns and choose the **Merge Columns** option.
    ...
    :::image type="content" source="./Media/MergeColumns.png" alt-text="Merge Columns option.":::
...
1. Within the **Merge columns** window change the **Separator** option to **Space**, set the **New column name (optional)** option to **Full Name** and select **OK** when complete.
    ...
    :::image type="content" source="./Media/MergeColumnsBox.png" alt-text="Merge columns dialogue window.":::
...
1. In the **Query settings** pane on the right, navigate to the **Merge Columns** step, right click and select the **View Native Query** option.
    ...
    :::image type="content" source="./Media/ViewNativeQuery.png" alt-text="View Native Query.":::
...
:::image type="content" source="./Media/AddConditionalColumn.png" alt-text="View Native Query.":::
...
:::image type="content" source="./Media/ConditionalQuery.png" alt-text="View Native Query for Conditional Column.":::
...
:::image type="content" source="./Media/AddStep.png" alt-text="Add Step.":::
...
:::image type="content" source="./Media/PerformanceAnalyzer.png" alt-text="Performance analyzer.":::
1. Within the **Performance analyzer** pane, select **Start recording**.
:::image type="content" source="./Media/StartRecording.png" alt-text="Start recording button.":::
